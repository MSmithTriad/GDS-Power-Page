 ...
 */
function showDeleteConfirmation(appointmentId, appointmentTitle) {
 ...
 */
function hideAllDeleteMessages() {
    const successMsgBox = document.getElementById("delete-success-msgbox");
    const errorMsgBox = document.getElementById("delete-error-msgbox");
    if (successMsgBox)
...
function removeAppointmentRow(appointmentId) {
    ...
    if (!row) {
        ...
        console.log("Available rows:", Array.from(document.querySelectorAll("[data-appointment-id]")).map((el) => el.getAttribute("data-appointment-id")));
    ...
    setTimeout(() => {
        ...
        const tbody = document.querySelector(".govuk-table__body");
...
function confirmDelete() {
    ...
    window.webapi.safeAjax({
        ...
        success: function (data, textStatus, xhr) {
            ...
            console.log("Delete API call successful for appointment:", appointmentIdToRemove);
            // Hide loading state
            hideDeleteLoadingState();
            // Hide modal
            hideDeleteConfirmation();
